...
module Statement
  class Scraper
    ...
    def self.member_methods
      ...
      :moran, :murray, :thune, :tuberville, :warner, :boozman, :merkley, :rubio, :whitehouse, :wicker, :toddyoung, :britt, :markey, :budd]
    end
    ...
    def self.member_scrapers
      ...
      results = [sullivan, shaheen, timscott, angusking, document_query_new, sanders, media_body, scanlon, bera, meeks, norcross, vanhollen, barrasso, mikelee,
        ...
        boozman, merkley, rubio, whitehouse, wicker, toddyoung, britt, markey, budd].flatten
